        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-xl font-bold">SecureBank</span>
            </div>
            <p class="text-gray-400 max-w-sm">
              Your trusted financial partner since 1985. Building secure futures through innovative banking solutions.
            </p>
          ...
          <div class="space-y-4">
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li><a href="#" class="hover:text-white transition-colors">Investment Services</a></li>
              <li><a href="#" class="hover:text-white transition-colors">Loans & Mortgages</a></li>
              <li><a href="#" class="hover:text-white transition-colors">Mobile Banking</a></li>
            </ul>
          </div>
          ...
          <div class="space-y-4">
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li><a href="#" class="hover:text-white transition-colors">ATM Locations</a></li>
          ...
          <div class="space-y-4">
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li><a href="#" class="hover:text-white transition-colors">Disclosures</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8">
          <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div class="text-gray-400 text-sm">
              © 2025 SecureBank. All rights reserved. Member FDIC. Equal Housing Lender.
            </div>
